...
a["template"]=ct.replace("SUN",tl+sF+"</span>").replace("TIME",tl+tF+"</span>").replace("DATE",'<span>'+dF+'</span>')
if(-1==a["template"].indexOf("<sp"))a["template"]='<span>'+a["template"]+"</span>"
...
console.log("Clock powered by http://clock.is API.")